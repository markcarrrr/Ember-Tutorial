...
module('Integration | Component | rental-listing', function(hooks) {
  ...
  test('should toggle wide class on click', async function(assert) {
    ...
    assert.ok(this.element.querySelector('.image.wide'), 'should be large after click');

    await click('.image');

    assert.notOk(this.element.querySelector('.image.wide'), 'should be small after secondary click');
  });
});
